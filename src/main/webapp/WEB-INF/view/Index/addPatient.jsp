...
<div class="col-xs-12 col-sm-9 col-sm-offset-1">
    <form class="form-horizontal" role="form">
        <div class="form-group">
            <label for="forename" class="col-sm-2 control-label">First Name</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="forename" name="forename" placeholder="Enter First Name">
            </div>
            ...
            <div class="col-sm-10">
                <input type="date" class="form-control" id="dob" name="Date of Birth" placeholder="Enter Date of Birth">
            </div>
            <label for="Address" class="col-sm-2 control-label">Address</label>
            <div class="col-sm-10"><input type="address" class="form-control" id="address" name="address" placeholder="Enter Patient Address"></div>
            ...
            <label for="status" class="col-sm-2 control-label">In/Out-Patient</label>        
            <div class="col-sm-5 col-sm-offset-5">            
            <select class="form-control">
