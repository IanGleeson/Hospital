	...
	<form action="PatientServlet?action=addPatient" method="post" required>
		...
		<p>
			<input type="date" name="admissionDate" id="admissionDate"
				...
				onchange="admissionDateChecker();">
				<span style="color: red;" id="messageAdmission"></span>
		</p>
		...
		<p>Bed id</p>
		<p>
			<input type="number" name="bedId" min="0" max="200" placeholder="Bed Id" required>
		</p>
		
		<p>Doctor id</p>
		<p>
			<input type="number" name="doctorId" min="0" max="200" placeholder="Doctor Id" required>
		</p>
		
		<p>Department Id</p>
		<p>
			<input type="number" name="deptId" placeholder="Department Id"
